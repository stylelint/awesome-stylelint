...
- [stylelint-config-standard-vue](https://www.npmjs.com/package/stylelint-config-standard-vue) - Standard config for Vue.
...
- [zed-stylelint](https://zed.dev/extensions/stylelint) - Zed extension.
